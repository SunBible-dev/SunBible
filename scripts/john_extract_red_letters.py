...
def extract_red_letters(html_file):
    ...
    for chapter in chapters:
        ...
        if chapter_words["verses"]:
            words_output["John"].append(chapter_words)
...
def main():
    ...
    html_file = os.path.join(project_root, 'BibleBase', 'BibleBooksHTML', 'Book-id=41-John.html')
    words_output_file = os.path.join(project_root, 'json', 'john-red-letter.json')
